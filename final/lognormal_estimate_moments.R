# this finds appropriate parameters of a prior distribution 
# based on the desired moments of the prior distribution
# following the approach in "Method of Moments Using Monte Carlo Simulation" by Andrew Gelman (1995)
d = 4
