...
VALUES=({1001..2000}) # negishi has limit that job array can only have 1000 jobs at a time
...
export out_file=/home/angt/output/nonstan_$THISJOBVALUE.out # where the R output goes
...
cd /home/angt
module load r/4.2.2
R --no-save --no-restore CMD BATCH final/nonstan_from_func.R $out_file
